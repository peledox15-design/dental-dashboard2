      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 lg:col-span-1">
          ...
          <div className="mt-8 border-t pt-4">
            <h2 className="font-semibold text-gray-800 mb-3">System Features</h2>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              <div>
                <h2 className="text-2xl font-bold">Patient Dental Records</h2>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-slate-100 text-left">
                    <th className="p-4 rounded-l-2xl">Patient Name</th>
                ...
                <tbody>
                  {patients.map((patient) => (
                    ...
                    >
                      ...
                      <td className="p-4">{patient.treatment}</td>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-slate-50 rounded-2xl p-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Maria Santos - Root Canal</p>
                </div>
              ...
              <div className="flex items-center justify-between bg-slate-50 rounded-2xl p-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Angela Cruz - Consultation</p>
                </div>
              ...
              <div className="flex items-center justify-between bg-slate-50 rounded-2xl p-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">John Reyes - Cleaning</p>
                </div>
